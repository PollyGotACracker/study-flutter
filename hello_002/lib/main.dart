 ...
 * 반드시 build 함수를 재정의(implement) 해야 한다.
 */

class App extends StatelessWidget {
  // App 의 생성자는 StatelessWidget 의 생성자를 호출
  const App({super.key});
  @override
 ...
 * return materialApp;
 * 
 * aterialApp materialApp = new MaterialApp(속성들 주입);
 * return materialApp;
 */
...
/*
 * required 키워드
 * 함수, 생성자 매개변수를 설정할 때 변수 앞에 붙이는 키워드
 * 함수, 생성자를 호출할 때 반드시 전달(주입)해야 하는 변수임을 명시
 */
